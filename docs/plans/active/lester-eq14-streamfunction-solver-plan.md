...
- NEXT: `SF-20`
- Active runtime goal: `Incorporar Anderson acceleration con profundidad configurable y salvaguardas.`
...
- [ ] [SF-20 — Anderson acceleration](lester-eq14/increments/SF-20-anderson.md)
- [ ] [SF-21 — Heterogeneity continuation](lester-eq14/increments/SF-21-heterogeneity-continuation.md)
- [ ] [SF-22 — Grid continuation](lester-eq14/increments/SF-22-grid-continuation.md)
