---
name: macroflow-build
description: Local configure / build / test flow for MacroFlow3D. Use for any task that requires building the project locally in WSL.
allowed-tools: Bash(cmake *) Bash(ctest *) Bash(ninja *) Bash(make *)
---
