---
name: macroflow-physics-review
description: Review workflow for changes touching scientific or numerical behavior in MacroFlow3D. Use when reviewing changes to src/numerics/, src/physics/, src/multigrid/, or any code path that changes numerical output.
---
