---
name: macroflow-evals
description: Eval tiers and execution commands for MacroFlow3D validation. Use to determine which validation tier applies to a change and execute the corresponding commands.
allowed-tools: Bash(cmake *) Bash(ctest *) Bash(ssh *) Bash(scripts/*)
---
