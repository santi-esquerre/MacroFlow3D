...
VarCoeffLaplacian::VarCoeffLaplacian(const Grid3D& grid, DeviceSpan<const real> K, const BCSpec& bc,
                                     PinSpec pin)
...
__global__ void varcoeff_apply_interior_kernel(const real* __restrict__ x,
                                               ...
                                               int Nx, int Ny, int Nz, real inv_dx2) {
...
// ============================================================================
__global__ void varcoeff_apply_boundary_kernel(const real* __restrict__ x,
                                               const real* __restrict__ K, real* __restrict__ y,
                                               int Nx, int Ny, int Nz, real inv_dx2,
                                               BCSpecDevice bc, bool pin1stCell) {
...
void VarCoeffLaplacian::apply(CudaContext& ctx, DeviceSpan<const real> x,
